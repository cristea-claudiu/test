...
const UseEffect1 = (props) => {
    ...
    useEffect(()=>{
         ...
         return ()=>{
          console.log( "UNMOUNTING: this function will execute when component unmounts (when we leave component)")
         }
    }, [])
    ...
    useEffect(()=>{
        ...
        return ()=>{
          console.log( "UNMOUNTING2: this function will execute when component unmounts (when we leave component)")
         }
   })
   ...
   useEffect(()=>{
    console.log(`UPDATING: This code will track state ("message") or props and will be
     ...
     return ()=>{
      console.log( "UNMOUNTING3: this function will execute when component unmounts (when we leave component)")
     }
}, [message, props])
